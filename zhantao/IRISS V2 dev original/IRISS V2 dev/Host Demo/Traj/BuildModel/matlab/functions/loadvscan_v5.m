function vscan = loadvscan_v5(DDIR, SCAN_NO_ACh)
%loadvscan MJG 2021-09-07
%   loads vscan, normalizes it, and scales the pixels to 1:1:1 square cubes

    % Add trailing slash to the directory in case it doesn't exist
    ...
    % the new size is [376 400 400] (note the ZXY order)
    % then the resize is performed: 
    vscan = imresize3(vscan, [376 400 400]);
